...
namespace crackitsoft\helpers\gii\crud;
...
class Generator extends \yii\gii\Generator
{
     ...
     * @var string
     */
    public $baseControllerClass = 'crackitsoft\helpers\ApiController';
    /**
     * @var string
     */
        ...
        foreach ($columns as $column => $type) {
            switch ($type) {
                ...
                default:
                    ...
                    $likeConditions[] = "->orFilterWhere(['{$likeKeyword}', '{$column}', \$this->{$column}])";                    
                    break;
            }
        }
